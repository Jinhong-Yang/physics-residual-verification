...
For each scale $\beta\in\{0,0.05,0.10,0.20\}$, the complete model mean is held fixed and $\Sigma_\beta=C+\operatorname{diag}[(\beta d)^2]$. The existing evaluated cohort is rescored without refitting. The original model remains at $\beta=0.10$; this is descriptive sensitivity rather than confirmation-cohort reselection.
