...
\title{Supplementary Material\\\large Protocol-Constrained Residual Adaptation for Rigid-Body Inference: A Bounded Evaluation of Frozen Visual Features}
...
\begin{table}[h]\centering\small
\caption{Recorded protection rows: three distinct nontrivial comparisons. Both conventions use the same 72 geometry families.}
